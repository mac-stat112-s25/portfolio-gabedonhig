...
courses |>
  mutate("9:40-10:40" = str_detect(time, "9:40")) |>
  mutate("1:10-2:10" = str_detect(time, "1:10")) |>
  mutate("3:00-4:30" = str_detect(time, "3:00")) |>
  mutate("7:00-10:00" = str_detect(time, "7:00")) |>
  mutate("1:20-2:50" = str_detect(time, "1:20")) |>
  group_by("9:40-10:40")
  # separate(days, c("MWRF", "R"),
  #          "(?<=[T])(?=[MWRF ])",
  # )
